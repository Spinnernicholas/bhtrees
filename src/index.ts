...
export type { DebugCommand, DebugCommandResult, DebugSnapshot, DebuggerOptions, DebuggerClient, DebugEventSummary, EntryBreakpoint, DebugStepResult, DebugWatchpoint } from './debugger.js';
