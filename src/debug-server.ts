    ...
    try {
      ...
      if (path === '/api/state' && request.method === 'GET') {
        ...
        send(200, { version: 1, capabilities: client.capabilities, definition: { root: tree.id, nodes },
          ...
          breakpoints: state.breakpoints, breakpointHit: state.breakpointHit, stepResult: state.stepResult,
          watchpoints: state.watchpoints, watchpointHit: inspectDebugValue(state.watchpointHit) }); return;
      }
